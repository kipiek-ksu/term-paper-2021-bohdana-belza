...
<form class="barsearchform" action="" onsubmit="return false">
	...
	<input class="search_field" id="query" value="" onsubmit="search();"  type="text"/>
...
<style type="text/css">
#alm {	display:block; position:absolute; width: 350px; top: 10px; left:10px; border:0px solid #888;}

#virtbook {	display:block; width: 800px; height: 530px; left:0px; top:0px; float:top; border:0px solid #ffddee;}
#sel {	height: 450px; display:block;  overflow-y:scroll; overflow-x: hidden; border:1px solid #A6A7A1;
...
?>
	...
	<div id="centerbox">
       <div style="top:0px;left:0px;right:0px; height:11px; float:bottom;">
        	<div style="top:0px; left:0px; height:11px; width:11px; float:left;
				background : url('<?php echo $CFG->wwwroot.'/theme/'.current_theme() ?>/pix/bg/bg_content_top_left.png'); background-repeat: no-repeat;"></div>
    		<div style="top:0px; right:0px; height:11px; width:11px; float:right;
				background : url('<?php echo $CFG->wwwroot.'/theme/'.current_theme() ?>/pix/bg/bg_content_top_right.png'); background-repeat: no-repeat;"></div>
       </div>
		<!--div style="background-repeat: no-repeat;
				background : url('<?php echo $CFG->wwwroot.'/theme/'.current_theme() ?>/pix/bg/bg_content_top_left.png'); float:left; top:0px; left:0px; height:11px;width:11px;"></div>
		<div style="background-repeat: no-repeat;
				background : url('<?php echo $CFG->wwwroot.'/theme/'.current_theme() ?>/pix/bg/bg_content_top_right.png'); float:right; top:0px; right:0px; height:11px;width:11px;"></div-->
        ...
        <!--div style="left:0px;right:0px; height:11px; vertical-align:bottom; float:right; ">
        	<div style="top:0px; left:0px; height:11px; width:11px; float:left;
				background : url('<?php echo $CFG->wwwroot.'/theme/'.current_theme() ?>/pix/bg/bg_content_bottom_left.png'); background-repeat: no-repeat;"></div>
    		<div style="top:0px; right:0px; height:11px; width:11px; float:right;
				background : url('<?php echo $CFG->wwwroot.'/theme/'.current_theme() ?>/pix/bg/bg_content_bottom_right.png'); background-repeat: no-repeat;"></div-->

			<!--div style="background-repeat: no-repeat;
				background : url('<?php echo $CFG->wwwroot.'/theme/'.current_theme() ?>/pix/bg/bg_content_bottom_left.png'); float:left; bottom:0px; left:0px; height:11px;width:11px;"></div-->
			<!--div style="background-repeat: no-repeat;
				background : url('<?php echo $CFG->wwwroot.'/theme/'.current_theme() ?>/pix/bg/bg_content_bottom_right.png'); float:right; bottom:0px; right:0px; height:11px;width:11px;"></div-->
		<!--/div-->
