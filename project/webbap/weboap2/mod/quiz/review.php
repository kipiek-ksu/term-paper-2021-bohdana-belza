<?php  // $Id: review.php,v 1.50.2.1 2007/03/20 22:45:04 tjhunt Exp $
/**
* This page prints a review of a particular quiz attempt
*
* @version $Id: review.php,v 1.50.2.1 2007/03/20 22:45:04 tjhunt Exp $
...
/// Print infobox
	...
	if ($options->scores) {
        if ($quiz->grade and $quiz->sumgrades) {
			...
			$table->data[] = array(get_string('feedback', 'quiz'), get_string('outof', 'quiz', $a));
        }
    }
    if ($options->overallfeedback && $feedback) {
       // $table->data[] = array(get_string('feedback', 'quiz'), $feedback);
		...
		$table->data[] = array("$strgrade:", $text);
