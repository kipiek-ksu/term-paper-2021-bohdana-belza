...
function expandData () {
	new Ajax.Updater('','pjax_chapter.php?curparent='+global_parent+'&edit='+global_edit+'&labs='+global_book+'&sesskey='+global_skey,{ method:'GET' , onComplete: succesChapter, onFailure: erreurRetourAjax, onLoading: showLoading});
}
