...
$string['allunsubscribe'] = 'Аннулировать подписку на все форумы';
...
$string['forumbodyhidden'] = 'Вы не можете просмотреть это сообщение, возможно потому что вы еще не отвечали в этой теме.';
