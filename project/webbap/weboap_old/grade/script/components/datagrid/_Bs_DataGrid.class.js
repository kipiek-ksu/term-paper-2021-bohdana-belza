...
this._tagId = tagId;if (this.bHeaderFix) {
overflowbuttonHtml = this._getFixButton('expand');} else {
overflowbuttonHtml = '';}
...
bs_dg_sort = 'alpha';}
bs_dg_sort_ignoreCase = this.sortIgnoreCase;this._data.sort(bs_datagrid_sort);this.drawInto(this._tagId);document.getElementById(this._objectId + '_title_td_' + column).className += ' bsDb_td_header_sort';}
...
valA = parseFloat(valA);valB = parseFloat(valB);if (valA < valB) {
