...
$string['showtime'] = 'Slideshow delay time:';
$string['noautoplay'] = 'no autoplay';

// for view.php
$string['none_found'] = 'No jpg images in directory ';
...
// for captions.php
$string['captiontext'] = 'You can enter quite a large amount of text and html in the caption fields. <p>To make your captions permanent, you must use the &quot;save changes&quot; button which is near the bottom of the page.';
$string['captionedit'] = 'editing captions for ';
...
$string['keeporiginals'] = 'If originals are to be kept, the original image will be copied to a seperate folder if it is resized. Otherwise only the resized version of the image is kept and server space is maximised.';
?>
