...
/// We also assume that $user, $course, $currenttab have been set
    ...
    /// add logic to see solutions
        if (has_capability('moodle/user:readuserposts', $personalcontext) || has_capability('mod/vinttaskbook:viewdiscussion', get_context_instance(CONTEXT_COURSE, $course->id))) {
            $toprow[] = new tabobject('vinttaskbook', $CFG->wwwroot.'/mod/vinttaskbook/user.php?id='.$user->id.'&amp;course='.$course->id,
                        get_string('vinttaskbook', 'solutions'));
