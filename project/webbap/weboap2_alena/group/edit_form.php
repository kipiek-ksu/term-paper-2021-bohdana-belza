...
class group_edit_form extends moodleform {
    ...
    function definition () {
		...
		$t = get_records_sql("SELECT a.id, a.firstname, a.lastname FROM mdl_user a INNER JOIN mdl_role_assignments b ON a.id = b.userid WHERE b.roleid = 3 ORDER BY lastname, firstname");
		$teachers = array('-1' => '');
