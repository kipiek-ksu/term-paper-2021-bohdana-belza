...
$string['filelockedmail'] = 'Текстовий файл, використовуваний вами для реєстрації не вдається видалити з помошью процесу cron. Звичайне це означає невірну установку прав доступу. Будь ласка виправіть права доступу до файлу, так щоб Moodle міг уго видалити, інакше він може бути оброблений більше одного разу.';
